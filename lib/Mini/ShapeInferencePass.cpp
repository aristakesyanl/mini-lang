...
#include "Mini/ShapeInferenceOpInterface.cpp.inc"
...
struct ShapeInferencePass
    : public mlir::PassWrapper<ShapeInferencePass, OperationPass<mini_lang::FuncOp>> {
...
std::unique_ptr<mlir::Pass> mlir::mini_lang::createShapeInferencePass() {
